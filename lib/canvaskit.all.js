...
( function(CanvasKit) {"use strict";
		...
		CanvasKit.Algorithm = {
			...
			alignText: function (topleft,bottomright, textwidth)
			{
				...
				return new CanvasKit.Point (center.x - pivotwidth, center.y);				
		...
		CanvasKit.Rectangle = ( function() {
				...
				rectangle.prototype.render = function(canvas, ctxt) {
					...
					if( this.contentstyle.text.length > 0){
						ctxt.font = "10pt Arial"; //'italic 40pt Calibri';
						var textwidth = ctxt.measureText( this.contentstyle.text).width;
						var textlocation = CanvasKit.Algorithm.alignText(this.location,this.bottomRight(),textwidth);
